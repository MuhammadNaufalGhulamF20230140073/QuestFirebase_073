...
import com.example.questfirebase_073.viewmodel.DetailViewModel
import com.example.questfirebase_073.viewmodel.PenyediaViewModel
import com.example.questfirebase_073.viewmodel.StatusUIDetail
            ...
            FloatingActionButton(
                onClick = {
                    ...
                    if (uiState is StatusUIDetail.Success) {
                        // PERBAIKAN 1: Tambahkan '!!' karena kita yakin data ada di state Success
                        // atau gunakan '?.let' untuk lebih aman
